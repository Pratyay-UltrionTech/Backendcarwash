...
class CatalogServiceItem(Base, TimestampMixin):
    ...
    excluded_points: Mapped[str] = mapped_column(Text, default="[]")  # JSON array as text
    ...
    # User portal display order: lower = earlier; legacy rows default 999 after migration.
