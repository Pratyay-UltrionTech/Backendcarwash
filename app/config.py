...
class Settings(BaseSettings):
    ...
    azure_comm_connection_string: str | None = Field(default=None, alias="AZURE_COMM_CONNECTION_STRING")
    azure_comm_sender: str = Field(
        default="DoNotReply@e6b4ee4e-0644-4c1f-ac4c-24f7e4507bb8.azurecomm.net",
        alias="AZURE_COMM_SENDER",
    )
    ...
    def _is_azure_postgres_host(self) -> bool:
        ...
        is_postgres = url.startswith("postgresql") or (not url and host)
        return is_postgres and "database.azure.com" in (url + host)
