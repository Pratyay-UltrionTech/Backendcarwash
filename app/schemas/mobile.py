...
class MobileServiceItemIn(BaseModel):
    ...
    category: str = "Washing"
    sequence: int = Field(default=999, ge=1, description="Display order in user portal; lower numbers appear first.")
...
class MobileDriverLeaveRequestCreate(BaseModel):
    leave_date: str
...
class MobileDriverLeaveRequestStatusUpdate(BaseModel):
    status: str
